...
async def zee5_capture(bot, update):
    ...
    try:
        ...
        if t_response:
            ...
            await update.reply_text("Link Not Valid Or  DRM protected", quote=True)
            return
    except:
        ...
        if t_response:
            ...
            if file_size > Config.TG_MAX_FILE_SIZE:
                ...
                await bot.edit_message_text(
                    ...
                    reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Join Channel", url="https://t.me/David_Botz")]]),
                    chat_id=update.message.chat.id,
                    message_id=update.message.message_id,
