class Translation(object):
    START_TEXT = """Hi , Iam All In One Bot 
/help for help
...
"""
    ...
    # UPGRADE_TEXT = " Please Try Again Or Contact My Master --> @David9010 "
    UPGRADE_TEXT = """ Please Check And Try Again Or Contact My Master --> @David9010 """
    FORMAT_SELECTION = "Please Select In Which Format You Want To Download: <a href='{}'>File Size Might Be Approximate</a> \nIf You Want To Set Custom Thumbnail, Then Send Me A photo Before Selecting Your Format."
...
URL | filename | username | password"""
    ...
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Detected File Size: {}. Free Users can only upload: {}\nPlease /upgrade your subscription.\nIf you think this is a bug, please contact <a href='https://t.me/@David9010'</a>"
    ...
    NO_VOID_FORMAT_FOUND = " Please Check Your Link And Try Again Or Replace It . Contact My Master @David9010\n<b>YouTubeDL</b> said: {}"
    USER_ADDED_TO_DB = "User <a href='tg://user?id={}'>{}</a> added to {} till {}."
    CURENT_PLAN_DETAILS = """About Me 
--------
...
/upgrade or Try today midnight later."""
    ...
    FED_UP_WITH_CRAP = "This bot is no longer leeching links for free users. @David9010 is open source, and you can deploy your own telegram upload by clicking on the links, available in GitHub README. or, Better /upgrade the subscription to continue using this bot."
